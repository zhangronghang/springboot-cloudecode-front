const r = [
  ...
  { code: "460302", name: "西沙区" },
  { code: "460303", name: "南沙区" },
...
function p(e, a) {
  const n = l(e);
  if (a && n.length !== e.length)
    throw new Error("不存在的地区名称");
  return n;
}
function l(e) {
  if (e.length === 0)
...
export {
  r as default,
  i as getDivisionChildren,
  C as getDivisionParent,
  u as getTopDivisions,
  s as isExistingCode,
  v as isFinalDivision,
  g as matchDivisionByCode,
  p as matchDivisionByNames
};
